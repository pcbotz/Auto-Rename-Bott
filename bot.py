...
class Bot(Client):
    def __init__(self):
        super().__init__(
            ...
            api_id='21136840',#Config.API_ID,
            api_hash='0f2ff6ef89fcd5ba226c3f40342f5319',#Config.API_HASH,
            bot_token='7026017463:AAF8PzDfiW9cfcPI37OXiQQUOHMxiELL6gM',#Config.BOT_TOKEN,
            workers=200,
